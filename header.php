				...
				<div class="social-icon-wrapper">
					<?php
						...
						$gdl_social_icon = array(
							...
							'skype' => array('name'=>THEME_SHORT_NAME.'_skype', 'url'=> GOODLAYERS_PATH.'/images/icon/' . $gdl_icon_type . '/social/skype.png'),
							'googleplus' => array('name'=>THEME_SHORT_NAME.'_googleplus', 'url'=> GOODLAYERS_PATH.'/images/icon/' . $gdl_icon_type . '/social/googleplus.png'),
