	...
	*/
	...
	$goodlayers_element = array(
		...
		'gdl_panel_social_network' => array( 
			...
			__('SKYPE', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_skype',
				'description'=>'Place the link you want and skype icon will appear. To remove it, just leave it blank.'),				
			__('GOOGLE PLUS', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_googleplus',
		...
		'gdl_panel_body' => array(	
			...
			__('CONTAINER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_container_background','default'=>'#ffffff',
				'description'=>'Container background is a background over the body background. You can change it to any color you want.'),
		...
		'gdl_panel_blog_port' => array(
			...
			__('PORT FILTER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_color','default'=>'#a1a1a1'),
			__('PORT FILTER COLOR HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_color_hover','default'=>'#272727'),
			__('PORT FILTER COLOR ACTIVE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_color_active','default'=>'#272727'),
			__('PORT INFO TOP BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_info_top_bar','default'=>'#b4b4b4'),
			__('BLOG TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_color','default'=>'#2b2b2b',
		...
		'gdl_panel_blog_port_translator' => array(
			...
			__('TAG (BLOG/PORTFOLIO)', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_blog_tag','default'=>'Tags: '),
