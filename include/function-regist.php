<?php
	...
	*/
	...
	if (function_exists('register_sidebar')){	
		...
		$sidebar_attr = array(
			'name' => '',
			'before_widget' => '<div class="custom-sidebar gdl-divider %2$s" div id="%1$s">',
			'after_widget' => '</div>',
		...
		$sidebar_attr['before_title'] = '<div class="sidebar-title-wrapper"><h3 class="custom-sidebar-title sidebar-title-color gdl-title">';
		$sidebar_attr['after_title'] = '</h3><div class="sidebar-title-wrapper-line gdl-divider"></div><div class="clear"></div></div>';
